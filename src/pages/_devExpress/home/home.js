            ...
            <div className={"dx-card responsive-paddings"}>
                ...
                <ul>
                    ...
                    <li>
                        <a
                            href={
                                "https://js.devexpress.com/Documentation/Guide/Getting_Started/DevExtreme_CLI/"
                            }
                            target={"_blank"}
                            rel={"noopener noreferrer"}
                        >
                ...
                <p>
                    ...
                    <a
                        href={
                            "https://js.devexpress.com/Documentation/ApiReference/UI_Widgets/dxDrawer/"
                        }
                        target={"_blank"}
                        rel={"noopener noreferrer"}
                    >
                    ...
                    component. Several component examples are also available in
                    the <b>Examples</b> section. For complete information on
                    DevExtreme, check our{" "}
                    <a
                ...
                <p>
                    You can do the following to create a custom application
                    using this template as a base point:
                </p>
                ...
                <p>
                    ...
                    <a
                        href={
                            "https://github.com/DevExpress/devextreme-react-template/blob/master/README.md"
                        }
                        target={"_blank"}
                        rel={"noopener noreferrer"}
                    >
